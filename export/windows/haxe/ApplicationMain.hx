...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("CinemaEngine2", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("CinemaEngine2", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "TeamCinemamakers";
		app.meta["file"] = "CinemaEngine2";
		app.meta["name"] = "Cinema Engine 2";
		...
		#elseif air
		app.window.title = "Cinema Engine 2";
		#else
