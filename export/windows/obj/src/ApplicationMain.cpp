...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("CinemaEngine2",1f,cd,4a,b7),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("TeamCinemamakers",3d,35,2f,55));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("CinemaEngine2",1f,cd,4a,b7));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Cinema Engine 2",63,79,ef,0e));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Cinema Engine 2",63,79,ef,0e))
